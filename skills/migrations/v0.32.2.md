...
feature_pitch:
  ...
  description: >-
    v0.31 added hot-memory facts but they lived only in the database. v0.32.2
    fences them in markdown so they survive `gbrain rebuild`. Migration v0_32_2
    backfills existing facts to entity-page fences. Plus a 3-layer privacy strip
    and a CI gate that enforces the rule going forward.
---
