...
version: v0.35.7.0
feature_pitch: >
  Typed metric claims, chronological trajectory queries, and a founder scorecard
  CLI. The temporal axis the v0.35.3.1 contradiction probe needed in order to be
  useful, finally landed.
---
