...
target_files:
  - >-
    sources.config (per-source webhook_secret, github_repo, tracked_branch,
    priority)
  - sources.config.federated (auto-embed-backfill on flip)
feature_pitch: >-
  Federated Sync v2 — parallel source sync, push-triggered webhooks, async
  embedding, per-source health dashboard
---
