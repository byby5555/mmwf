...
feature_pitch:
  tiers:
    - name: Core tools (everyone)
      ...
      description: >-
        publish, backlinks, lint, report -- zero external deps, work
        immediately.
    - name: With Supabase Storage
      setup: 'Configure storage backend, then gbrain files mirror + redirect.'
      description: >-
        upload-raw, signed-url, file migration lifecycle. Large files in cloud,
        git stays lean.
  headline: '5 new deterministic tools, smart file uploads, production-grade skills'
  description: >-
    gbrain publish, backlinks, lint, report, and upload-raw. Code+skill pairs --
    deterministic TypeScript does the work, skills tell the agent when to use
    it. Plus TUS resumable uploads, .redirect.yaml pointers, and battle-tested
    skill patterns.
---
