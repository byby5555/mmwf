---
type: concept
title: voice-note-ingest — Exact-Phrasing Voice Capture
...
writes_to:
  ...
  - personal/
description: >-
  Ingest a voice note with exact-phrasing preservation (never paraphrased).
  Routes content to originals/, concepts/, people/, companies/, ideas/,
  personal/, or voice-notes/ based on a decision tree. The user's exact words
  are the signal.
writes_pages: true
---
