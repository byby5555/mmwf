---
type: concept
title: archive-crawler — The Universal Archivist
...
writes_to:
  ...
  - ideas/
description: >-
  Universal archivist for personal file archives
  (Dropbox/B2/Gmail-takeout/local-mount/hard-drive-dump). Filters for high-value
  content (the user's own writing, ideas, relationships) and surfaces it
  interactively. REFUSES TO RUN without an explicit gbrain.yml
  `archive-crawler.scan_paths:` allow-list.
writes_pages: true
---
