---
type: concept
title: capture — the single ingestion entrypoint
name: capture
triggers:
  - capture this
  - save this thought
  ...
  - save to brain
description: >-
  Save any thought or content into the brain via one CLI command. The single
  human-facing entrypoint that replaces "put_page vs commit-then-sync vs
  autopilot-wait" with one command that just works.
writes_pages:
  - inbox/*
---
