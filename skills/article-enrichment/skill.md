---
type: concept
title: article-enrichment — From Raw Dumps to Useful Brain Pages
...
writes_to:
  - media/articles/
description: >-
  Transform raw article text dumps in the brain into structured pages with
  executive summary, verbatim quotes, key insights, why-it-matters, and
  cross-references. Replaces walls-of-text with quotable, actionable brain
  pages.
writes_pages: true
---
