---
type: concept
title: brain-pdf — Render a Brain Page to Publication-Quality PDF
name: brain-pdf
version: 0.1.0
triggers:
  - make pdf from brain
  ...
  - export brain page
description: >-
  Generate a publication-quality PDF from any brain page via the gstack make-pdf
  binary. Strips YAML frontmatter, sanitizes emoji, applies running headers and
  page numbers. Brain page is always the source of truth; PDF is a rendering.
---
