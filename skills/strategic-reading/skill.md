---
type: concept
title: Brain-first analyzer matches `web_fetch` in a diagram on line 106
...
writes_to:
  ...
  - projects/
description: >-
  Read a book, article, transcript, or case study through the lens of a specific
  strategic problem you're facing. Produces an applied playbook that maps the
  source onto the problem and gives short/medium/long-term recommendations. NOT
  for general book summaries.
writes_pages: true
---
