---
type: concept
title: book-mirror — Personalized Chapter-by-Chapter Book Analysis
name: book-mirror
version: 0.1.0
mutating: true
triggers:
...
description: >-
  ...
  with two-column tables. Left column preserves the chapter content; right
  column maps every idea to the reader's actual life using brain context. Output
  is a single brain page at media/books/<slug>-personalized.md plus an optional
  PDF via brain-pdf.
writes_pages: true
---
