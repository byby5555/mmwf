---
type: concept
title: schema-author — evolve your schema pack
name: schema-author
tools:
...
brain_first: exempt
description: >-
  Evolve your brain's schema pack. Add page types, propose new ones from corpus
  scans, backfill page.type on existing pages, audit pack health. Triggers when
  an agent notices untyped pages, custom domains needing typed entities
  (researcher, contract, deposition), or wants to see what types the pack
  declares.
writes_pages: []
---
